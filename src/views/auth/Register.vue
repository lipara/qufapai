  ...
  <div class="login-container">
    <el-form ref="registerForm" :model="form" :rules="loginRules" class="login-form" auto-complete="on" label-position="left">
      ...
      <el-form-item prop="password">
        <el-input ref="password" v-model="form.password" type="password" placeholder="请输入密码" />
      </el-form-item>

      <el-form-item prop="confirmPassword">
        <el-input ref="confirmPassword" v-model="form.confirmPassword" type="password" placeholder="请再次输入密码" />
      </el-form-item>
      ...
      <el-button :loading="loading" class="loginbtn" @click="confirmSave">注册并登录</el-button>
    </el-form>
  </div>
</template>
<script>
